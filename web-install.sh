...
s=s.replace("VERSION='0.5.0'", "VERSION='0.11.10'", 1)
...
info 'Перевожу веб-панель на проверенную blue/green схему 0.11.10...'
get_update "$TMP/update-after-web.sh"
bash "$TMP/update-after-web.sh"

ok "MTPADMIN Web $VERSION готов. Source lifecycle, persistent stats, Update Center repair, VPN BOSS integration и WEB Proxy activity telemetry включены; autoban=OFF."
