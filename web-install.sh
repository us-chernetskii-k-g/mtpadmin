...
s=s.replace("VERSION='0.5.0'", "VERSION='0.11.13'", 1)
...
info 'Перевожу веб-панель на проверенную blue/green схему 0.11.13...'
get_update "$TMP/update-after-web.sh"
run_update "$TMP/update-after-web.sh"

ok "MTPADMIN Web $VERSION готов. Disk-safe WEB telemetry, source lifecycle, persistent stats, Update Center routing safety, VPN BOSS integration и WEB client telemetry включены; autoban=OFF."
