...
bash -n "$TMP/update-090.sh" || die '0.11.0 сформировал невалидный updater.'
grep -q "VERSION='0.11.0'" "$TMP/update-090.sh" || die 'Версия updater не обновилась.'
